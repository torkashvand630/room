var whiteboardId = board.meetID;// getQueryVariable("whiteboardid");
//whiteboardId = whiteboardId || "myNewWhiteboard";
var myUsername = board.userName;// getQueryVariable("username");
var accessToken = "11";// getQueryVariable("accesstoken");
myUsername = myUsername || "unknown" + (Math.random() + "").substring(2, 6);
accessToken = accessToken || "";
var accessDenied = false;
//console.warn("meet : " + whiteboardId + " userName= " + myUsername);
...
subdir = board.host;// "http://localhost:8080";
//if (subdir != "") {
//    signaling_socket = io("", { "path":  "localhost:8080/socket.io" }); //Connect even if we are in a subdir behind a reverse proxy
//} else {
//    signaling_socket = io();
//}
//signaling_socket = io(board.host);// io("", { "path": "localhost:8080/socket.io" }); //Connect even if we are in a subdir behind
//console.warn(subdir);
...
$(document).ready(function () {
 //   document.getElementsByClassName('penTools')[0].click();
